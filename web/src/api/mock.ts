...
const mockWorkflowDetails: WorkflowDetail[] = [
  {
    ...
    node_count: 8,
    last_executed: '2026-08-08T08:15:00Z',
    execution_count: 47,
  },
  {
    id: 'wf-002',
    ...
    node_count: 7,
    last_executed: '2026-08-07T16:20:00Z',
    execution_count: 31,
  },
  {
    id: 'wf-003',
  ...
  },
  {
    ...
    node_count: 9,
    last_executed: '2026-08-08T07:45:00Z',
    execution_count: 63,
  },
  {
    id: 'wf-005',
  ...
  // Kudig topic-fta entries
  { id: 'wf-kudig-node', name: 'Node 节点异常故障树', status: 'active', description: '覆盖节点不可用/不稳定的关键成因：节点状态、kubelet、运行时、系统资源、内核与网络、存储、证书与时间、控制面依赖', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 9, last_executed: '2026-08-12T14:20:00Z', execution_count: 23 },
  { id: 'wf-kudig-pod', name: 'Pod 异常故障树', status: 'active', description: '覆盖 Pod 启动、运行、终止阶段的异常：CrashLoopBackOff、OOMKilled、Pending、ImagePullBackOff', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 11, last_executed: '2026-08-12T16:00:00Z', execution_count: 67 },
  { id: 'wf-kudig-apiserver', name: 'API Server 异常故障树', status: 'active', description: '覆盖 APIServer 不可用/性能劣化的关键成因：进程与配置、认证鉴权、请求排队与限流、依赖组件、证书与时间', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-11T09:00:00Z', execution_count: 15 },
  { id: 'wf-kudig-etcd', name: 'Etcd 异常故障树', status: 'active', description: '覆盖 Etcd 集群异常的关键成因：进程与资源、WAL 与快照、磁盘 IO、网络分区、leadership 变更', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 10, last_executed: '2026-08-10T22:30:00Z', execution_count: 9 },
  { id: 'wf-kudig-dns', name: 'DNS 解析异常故障树', status: 'active', description: '覆盖 CoreDNS 异常、DNS 解析失败的根本成因：Pod 层面、节点层面、集群层面、网络策略', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-12T10:15:00Z', execution_count: 31 },
  { id: 'wf-kudig-ingress', name: 'Ingress/Gateway 故障树', status: 'active', description: '覆盖 Ingress Controller 异常、域名解析问题、证书问题的故障路径', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-11T15:45:00Z', execution_count: 18 },
  { id: 'wf-kudig-deployment', name: 'Deployment 异常故障树', status: 'active', description: '覆盖 Deployment Rollout 失败、ReplicaSet 不健康的根因：镜像拉取、资源配额、探针配置', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-12T08:30:00Z', execution_count: 42 },
  { id: 'wf-kudig-statefulset', name: 'StatefulSet 异常故障树', status: 'active', description: '覆盖 StatefulSet 异常的根本成因：PVC 挂载、序号分配、headless Service', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-10T16:20:00Z', execution_count: 11 },
  { id: 'wf-kudig-daemonset', name: 'DaemonSet 异常故障树', status: 'active', description: '覆盖 DaemonSet Pod 调度失败或异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-11T11:00:00Z', execution_count: 8 },
  { id: 'wf-kudig-job', name: 'Job/CronJob 异常故障树', status: 'active', description: '覆盖 Job 失败、CronJob 未按计划执行的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-12T09:00:00Z', execution_count: 14 },
  { id: 'wf-kudig-hpa', name: 'HPA 扩缩容异常故障树', status: 'active', description: '覆盖 HPA 无法扩缩容、缩容到 0 或扩容失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-11T14:30:00Z', execution_count: 19 },
  { id: 'wf-kudig-vpa', name: 'VPA 异常故障树', status: 'active', description: '覆盖 VPA 推荐值异常、更新失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-10T12:00:00Z', execution_count: 6 },
  { id: 'wf-kudig-csi', name: 'CSI 存储异常故障树', status: 'active', description: '覆盖 PersistentVolume 挂载失败、CSI driver 异常的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 9, last_executed: '2026-08-12T11:15:00Z', execution_count: 12 },
  { id: 'wf-kudig-rbac', name: 'RBAC 权限异常故障树', status: 'active', description: '覆盖 ServiceAccount 权限不足、RoleBinding/ClusterRoleBinding 配置错误的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-11T16:00:00Z', execution_count: 27 },
  { id: 'wf-kudig-certificate', name: 'Certificate 证书异常故障树', status: 'active', description: '覆盖 kubelet/apiserver/etcd 证书过期或无效的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-12T07:45:00Z', execution_count: 21 },
  { id: 'wf-kudig-scheduler', name: 'Scheduler 调度异常故障树', status: 'active', description: '覆盖 Pod 无法调度、调度延迟的根本成因：资源不足、亲和性冲突、污点', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 9, last_executed: '2026-08-11T13:20:00Z', execution_count: 33 },
  { id: 'wf-kudig-controller', name: 'Controller Manager 异常故障树', status: 'active', description: '覆盖 kube-controller-manager 异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-10T20:00:00Z', execution_count: 7 },
  { id: 'wf-kudig-monitoring', name: 'Monitoring 监控异常故障树', status: 'active', description: '覆盖 Prometheus 采集失败、Alertmanager 通知异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-12T06:30:00Z', execution_count: 16 },
  { id: 'wf-kudig-service', name: 'Service 连通性异常故障树', status: 'active', description: '覆盖 Service 无法访问、Endpoints 不健康的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-11T10:00:00Z', execution_count: 24 },
  { id: 'wf-kudig-nodepool', name: 'NodePool 节点池异常故障树', status: 'active', description: '覆盖节点池扩缩容异常、节点加入失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-12T13:00:00Z', execution_count: 10 },
  { id: 'wf-kudig-pdb', name: 'PDB 驱散异常故障树', status: 'active', description: '覆盖 PodDisruptionBudget 导致驱逐失败或无法完成的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-11T08:15:00Z', execution_count: 5 },
  { id: 'wf-kudig-autoscaler', name: 'Cluster Autoscaler 异常故障树', status: 'active', description: '覆盖 Cluster Autoscaler 无法扩容或缩容节点的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-12T15:30:00Z', execution_count: 9 },
  { id: 'wf-kudig-cluster-upgrade', name: '集群升级异常故障树', status: 'active', description: '覆盖集群升级失败、节点升级过程中异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 10, last_executed: '2026-08-11T22:00:00Z', execution_count: 4 },
  { id: 'wf-kudig-gateway', name: 'Gateway API 异常故障树', status: 'active', description: '覆盖 Gateway API 资源异常、HTTPRoute 绑定失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-10T18:00:00Z', execution_count: 8 },
  { id: 'wf-kudig-service-mesh', name: 'Service Mesh Istio 异常故障树', status: 'active', description: '覆盖 Istio 网格内服务无法通信、Sidecar 注入异常的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 9, last_executed: '2026-08-12T10:45:00Z', execution_count: 13 },
  { id: 'wf-kudig-gitops', name: 'GitOps ArgoCD 异常故障树', status: 'active', description: '覆盖 ArgoCD 同步失败、应用状态异常的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-11T20:30:00Z', execution_count: 11 },
  { id: 'wf-kudig-gpu', name: 'GPU 节点异常故障树', status: 'active', description: '覆盖 GPU 节点不可用、DevicePlugin 异常的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-12T17:00:00Z', execution_count: 7 },
  { id: 'wf-kudig-helm', name: 'Helm Release 异常故障树', status: 'active', description: '覆盖 Helm Release 升级失败、回滚异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-11T12:00:00Z', execution_count: 15 },
  { id: 'wf-kudig-crd', name: 'CRD/Operator 异常故障树', status: 'active', description: '覆盖 CustomResourceDefinition 异常、Operator 无法正常工作的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 9, last_executed: '2026-08-12T08:00:00Z', execution_count: 6 },
  { id: 'wf-kudig-networkpolicy', name: 'NetworkPolicy 异常故障树', status: 'active', description: '覆盖 NetworkPolicy 配置后流量不通的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-11T17:30:00Z', execution_count: 20 },
  { id: 'wf-kudig-psp', name: 'PSP/SCC 策略异常故障树', status: 'active', description: '覆盖 PodSecurityPolicy 或 SecurityContextConstraints 导致 Pod 创建失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 6, last_executed: '2026-08-10T14:00:00Z', execution_count: 5 },
  { id: 'wf-kudig-resourcequota', name: 'ResourceQuota 异常故障树', status: 'active', description: '覆盖 ResourceQuota/LimitRange 导致资源创建失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-11T09:45:00Z', execution_count: 18 },
  { id: 'wf-kudig-webhook', name: 'Webhook Admission 异常故障树', status: 'active', description: '覆盖 MutatingWebhook/ValidatingWebhook 导致资源创建/更新失败的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-12T12:00:00Z', execution_count: 9 },
  { id: 'wf-kudig-backup', name: 'Backup/Restore 异常故障树', status: 'active', description: '覆盖 Velero 备份失败、恢复异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 8, last_executed: '2026-08-11T23:00:00Z', execution_count: 4 },
  { id: 'wf-kudig-cloudprovider', name: 'Cloud Provider 异常故障树', status: 'active', description: '覆盖阿里云/AWS/GCP 云厂商特定资源异常的根本成因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 10, last_executed: '2026-08-12T14:00:00Z', execution_count: 8 },
  { id: 'wf-kudig-terway', name: 'Terway CNI 异常故障树', status: 'active', description: '覆盖阿里云 Terway CNI 网络异常的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-11T19:00:00Z', execution_count: 6 },
  { id: 'wf-kudig-monitoring-extra', name: 'Monitoring Extra 监控扩展异常故障树', status: 'active', description: '覆盖 Metrics Server、Prometheus Adapter 等监控扩展组件异常的根因', created_at: '2026-08-10T10:00:00Z', updated_at: '2026-08-10T10:00:00Z', node_count: 7, last_executed: '2026-08-10T21:00:00Z', execution_count: 5 },
];
...
const mockWorkflowExecutions: WorkflowExecutionRecord[] = [
  {
    ...
    completed_at: '2026-08-08T08:15:12Z',
  ...
  },
  {
    ...
    completed_at: '2026-08-07T14:30:18Z',
  ...
  },
  {
    ...
    status: 'completed',
    started_at: '2026-08-07T16:20:00Z',
    completed_at: '2026-08-07T16:20:25Z',
  ...
  },
  {
    ...
    status: 'completed',
    started_at: '2026-08-08T07:45:00Z',
    completed_at: '2026-08-08T07:45:30Z',
  ...
  },
  {
    ...
    workflow_name: 'ECS 实例 CPU 打满分析',
    status: 'failed',
    started_at: '2026-08-07T22:10:00Z',
    completed_at: '2026-08-07T22:10:45Z',
  ...
  },
  {
    ...
    workflow_name: 'K8s 节点 NotReady 故障树',
    status: 'running',
    started_at: '2026-08-08T09:50:00Z',
    completed_at: null,
  ...
  },
  {
    ...
    completed_at: '2026-08-06T11:00:15Z',
  ...
  { id: 'exec-kudig-001', workflow_id: 'wf-kudig-node', workflow_name: 'Node 节点异常故障树', status: 'completed', started_at: '2026-08-12T14:20:00Z', completed_at: '2026-08-12T14:20:18Z', trigger: 'alert-node-notready-cn-hz-05', root_cause: 'kubelet 进程 OOM 被 kill', nodes_evaluated: 9, duration_ms: 18200 },
  { id: 'exec-kudig-002', workflow_id: 'wf-kudig-pod', workflow_name: 'Pod 异常故障树', status: 'completed', started_at: '2026-08-12T16:00:00Z', completed_at: '2026-08-12T16:00:31Z', trigger: 'alert-pod-crashloop-cn-hz-01', root_cause: 'OOMKilled — 容器内存限制 512Mi 不足', nodes_evaluated: 11, duration_ms: 31400 },
  { id: 'exec-kudig-003', workflow_id: 'wf-kudig-pod', workflow_name: 'Pod 异常故障树', status: 'completed', started_at: '2026-08-11T10:30:00Z', completed_at: '2026-08-11T10:30:22Z', trigger: 'alert-pod-crashloop-cn-sh-02', root_cause: 'CrashLoopBackOff — exit code 1 应用启动脚本错误', nodes_evaluated: 8, duration_ms: 22300 },
  { id: 'exec-kudig-004', workflow_id: 'wf-kudig-apiserver', workflow_name: 'API Server 异常故障树', status: 'completed', started_at: '2026-08-11T09:00:00Z', completed_at: '2026-08-11T09:00:28Z', trigger: 'alert-apiserver-latency-high', root_cause: 'etcd 写入延迟过高，磁盘 IO 瓶颈', nodes_evaluated: 8, duration_ms: 28100 },
  { id: 'exec-kudig-005', workflow_id: 'wf-kudig-etcd', workflow_name: 'Etcd 异常故障树', status: 'completed', started_at: '2026-08-10T22:30:00Z', completed_at: '2026-08-10T22:30:15Z', trigger: 'alert-etcd-leader-change', root_cause: '网络抖动导致 leader 重新选举', nodes_evaluated: 10, duration_ms: 15200 },
  { id: 'exec-kudig-006', workflow_id: 'wf-kudig-dns', workflow_name: 'DNS 解析异常故障树', status: 'completed', started_at: '2026-08-12T10:15:00Z', completed_at: '2026-08-12T10:15:08Z', trigger: 'alert-dns-resolution-fail', root_cause: 'CoreDNS Pod 被驱逐，coredns 配置丢失', nodes_evaluated: 7, duration_ms: 8200 },
  { id: 'exec-kudig-007', workflow_id: 'wf-kudig-dns', workflow_name: 'DNS 解析异常故障树', status: 'completed', started_at: '2026-08-11T08:45:00Z', completed_at: '2026-08-11T08:45:12Z', trigger: 'alert-dns-timeout', root_cause: 'Node /etc/resolv.conf nameserver 配置被覆盖', nodes_evaluated: 6, duration_ms: 12100 },
  { id: 'exec-kudig-008', workflow_id: 'wf-kudig-ingress', workflow_name: 'Ingress/Gateway 故障树', status: 'completed', started_at: '2026-08-11T15:45:00Z', completed_at: '2026-08-11T15:45:19Z', trigger: 'alert-ingress-5xx', root_cause: 'Ingress Controller 证书过期', nodes_evaluated: 6, duration_ms: 19400 },
  { id: 'exec-kudig-009', workflow_id: 'wf-kudig-deployment', workflow_name: 'Deployment 异常故障树', status: 'completed', started_at: '2026-08-12T08:30:00Z', completed_at: '2026-08-12T08:30:42Z', trigger: 'alert-deploy-rollout-stuck', root_cause: 'ImagePullBackOff — 私有镜像仓库认证过期', nodes_evaluated: 8, duration_ms: 42300 },
  { id: 'exec-kudig-010', workflow_id: 'wf-kudig-deployment', workflow_name: 'Deployment 异常故障树', status: 'completed', started_at: '2026-08-11T14:00:00Z', completed_at: '2026-08-11T14:00:25Z', trigger: 'alert-deploy-replicasset-unhealthy', root_cause: 'liveness 探针连续失败 3 次，容器被重启', nodes_evaluated: 7, duration_ms: 25200 },
  { id: 'exec-kudig-011', workflow_id: 'wf-kudig-statefulset', workflow_name: 'StatefulSet 异常故障树', status: 'completed', started_at: '2026-08-10T16:20:00Z', completed_at: '2026-08-10T16:20:14Z', trigger: 'alert-statefulset-pvc-pending', root_cause: 'PVC 一直 Pending — 存储类不存在', nodes_evaluated: 7, duration_ms: 14200 },
  { id: 'exec-kudig-012', workflow_id: 'wf-kudig-daemonset', workflow_name: 'DaemonSet 异常故障树', status: 'completed', started_at: '2026-08-11T11:00:00Z', completed_at: '2026-08-11T11:00:09Z', trigger: 'alert-daemonset-pod-not-scheduled', root_cause: '节点污点 NoSchedule 未被 Pod 容忍', nodes_evaluated: 6, duration_ms: 9100 },
  { id: 'exec-kudig-013', workflow_id: 'wf-kudig-job', workflow_name: 'Job/CronJob 异常故障树', status: 'completed', started_at: '2026-08-12T09:00:00Z', completed_at: '2026-08-12T09:00:18Z', trigger: 'alert-job-failed', root_cause: '容器退出码 1 — 数据清洗脚本 SQL 语法错误', nodes_evaluated: 7, duration_ms: 18200 },
  { id: 'exec-kudig-014', workflow_id: 'wf-kudig-hpa', workflow_name: 'HPA 扩缩容异常故障树', status: 'completed', started_at: '2026-08-11T14:30:00Z', completed_at: '2026-08-11T14:30:11Z', trigger: 'alert-hpa-not-scaling', root_cause: 'metrics-server 未运行，HPA 无法获取指标', nodes_evaluated: 8, duration_ms: 11200 },
  { id: 'exec-kudig-015', workflow_id: 'wf-kudig-vpa', workflow_name: 'VPA 异常故障树', status: 'completed', started_at: '2026-08-10T12:00:00Z', completed_at: '2026-08-10T12:00:07Z', trigger: 'alert-vpa-update-failed', root_cause: 'VPA 推荐值超出资源限制范围', nodes_evaluated: 6, duration_ms: 7300 },
  { id: 'exec-kudig-016', workflow_id: 'wf-kudig-csi', workflow_name: 'CSI 存储异常故障树', status: 'completed', started_at: '2026-08-12T11:15:00Z', completed_at: '2026-08-12T11:15:22Z', trigger: 'alert-pvc-attach-failed', root_cause: 'CSI driver 插件异常退出，卷挂载失败', nodes_evaluated: 9, duration_ms: 22100 },
  { id: 'exec-kudig-017', workflow_id: 'wf-kudig-rbac', workflow_name: 'RBAC 权限异常故障树', status: 'completed', started_at: '2026-08-11T16:00:00Z', completed_at: '2026-08-11T16:00:13Z', trigger: 'alert-sa-permission-denied', root_cause: 'RoleBinding 未绑定正确的 ClusterRole', nodes_evaluated: 7, duration_ms: 13100 },
  { id: 'exec-kudig-018', workflow_id: 'wf-kudig-certificate', workflow_name: 'Certificate 证书异常故障树', status: 'completed', started_at: '2026-08-12T07:45:00Z', completed_at: '2026-08-12T07:45:09Z', trigger: 'alert-kubelet-cert-expiring', root_cause: 'kubelet 证书 30 天后过期，需手动续期', nodes_evaluated: 6, duration_ms: 9400 },
  { id: 'exec-kudig-019', workflow_id: 'wf-kudig-scheduler', workflow_name: 'Scheduler 调度异常故障树', status: 'completed', started_at: '2026-08-11T13:20:00Z', completed_at: '2026-08-11T13:20:27Z', trigger: 'alert-pod-unschedulable', root_cause: 'CPU 资源不足，节点所有可用 CPU 被占满', nodes_evaluated: 9, duration_ms: 27100 },
  { id: 'exec-kudig-020', workflow_id: 'wf-kudig-scheduler', workflow_name: 'Scheduler 调度异常故障树', status: 'failed', started_at: '2026-08-12T17:00:00Z', completed_at: '2026-08-12T17:00:30Z', trigger: 'alert-pod-unschedulable-2', root_cause: null, nodes_evaluated: 3, duration_ms: 30000 },
  { id: 'exec-kudig-021', workflow_id: 'wf-kudig-controller', workflow_name: 'Controller Manager 异常故障树', status: 'completed', started_at: '2026-08-10T20:00:00Z', completed_at: '2026-08-10T20:00:11Z', trigger: 'alert-controller-manager-down', root_cause: 'kube-controller-manager Pod 被OOMKill', nodes_evaluated: 7, duration_ms: 11200 },
  { id: 'exec-kudig-022', workflow_id: 'wf-kudig-monitoring', workflow_name: 'Monitoring 监控异常故障树', status: 'completed', started_at: '2026-08-12T06:30:00Z', completed_at: '2026-08-12T06:30:19Z', trigger: 'alert-prometheus-target-down', root_cause: 'Prometheus 采集 target 超时，网络策略阻断', nodes_evaluated: 8, duration_ms: 19200 },
  { id: 'exec-kudig-023', workflow_id: 'wf-kudig-service', workflow_name: 'Service 连通性异常故障树', status: 'completed', started_at: '2026-08-11T10:00:00Z', completed_at: '2026-08-11T10:00:08Z', trigger: 'alert-svc-endpoints-empty', root_cause: 'Service selector 写错，匹配不到后端 Pod', nodes_evaluated: 7, duration_ms: 8100 },
  { id: 'exec-kudig-024', workflow_id: 'wf-kudig-service', workflow_name: 'Service 连通性异常故障树', status: 'completed', started_at: '2026-08-12T13:30:00Z', completed_at: '2026-08-12T13:30:15Z', trigger: 'alert-svc-connection-refused', root_cause: '后端 Pod 全部非 Ready，NetworkPolicy 阻断', nodes_evaluated: 7, duration_ms: 15200 },
  { id: 'exec-kudig-025', workflow_id: 'wf-kudig-nodepool', workflow_name: 'NodePool 节点池异常故障树', status: 'completed', started_at: '2026-08-12T13:00:00Z', completed_at: '2026-08-12T13:00:22Z', trigger: 'alert-nodepool-scale-fail', root_cause: 'Cluster Autoscaler 无法扩容，云厂商配额不足', nodes_evaluated: 8, duration_ms: 22200 },
  { id: 'exec-kudig-026', workflow_id: 'wf-kudig-pdb', workflow_name: 'PDB 驱散异常故障树', status: 'completed', started_at: '2026-08-11T08:15:00Z', completed_at: '2026-08-11T08:15:06Z', trigger: 'alert-pdb-burst-allowed-0', root_cause: 'PDB minAvailable 配置过高，阻断正常驱逐', nodes_evaluated: 6, duration_ms: 6200 },
  { id: 'exec-kudig-027', workflow_id: 'wf-kudig-autoscaler', workflow_name: 'Cluster Autoscaler 异常故障树', status: 'completed', started_at: '2026-08-12T15:30:00Z', completed_at: '2026-08-12T15:30:14Z', trigger: 'alert-autoscaler-scale-fail', root_cause: 'Cluster Autoscaler 参数区域配置错误', nodes_evaluated: 8, duration_ms: 14200 },
  { id: 'exec-kudig-028', workflow_id: 'wf-kudig-cluster-upgrade', workflow_name: '集群升级异常故障树', status: 'completed', started_at: '2026-08-11T22:00:00Z', completed_at: '2026-08-11T22:00:48Z', trigger: 'alert-cluster-upgrade-failed', root_cause: '节点升级超时，控制面组件版本不兼容', nodes_evaluated: 10, duration_ms: 48100 },
  { id: 'exec-kudig-029', workflow_id: 'wf-kudig-gateway', workflow_name: 'Gateway API 异常故障树', status: 'completed', started_at: '2026-08-10T18:00:00Z', completed_at: '2026-08-10T18:00:11Z', trigger: 'alert-gateway-route-conflict', root_cause: 'HTTPRoute 绑定冲突，重复的 hostname', nodes_evaluated: 7, duration_ms: 11200 },
  { id: 'exec-kudig-030', workflow_id: 'wf-kudig-service-mesh', workflow_name: 'Service Mesh Istio 异常故障树', status: 'completed', started_at: '2026-08-12T10:45:00Z', completed_at: '2026-08-12T10:45:17Z', trigger: 'alert-istio-sidecar-injection-fail', root_cause: 'Sidecar 注入失败，namespace 标签配置错误', nodes_evaluated: 9, duration_ms: 17300 },
  { id: 'exec-kudig-031', workflow_id: 'wf-kudig-gitops', workflow_name: 'GitOps ArgoCD 异常故障树', status: 'completed', started_at: '2026-08-11T20:30:00Z', completed_at: '2026-08-11T20:30:24Z', trigger: 'alert-argocd-sync-failed', root_cause: 'ArgoCD Image Updater 配置错误，镜像 Tag 不存在', nodes_evaluated: 8, duration_ms: 24200 },
  { id: 'exec-kudig-032', workflow_id: 'wf-kudig-gpu', workflow_name: 'GPU 节点异常故障树', status: 'completed', started_at: '2026-08-12T17:00:00Z', completed_at: '2026-08-12T17:00:31Z', trigger: 'alert-gpu-device-plugin-fail', root_cause: 'GPU 节点 DevicePlugin 注册失败，驱动版本不兼容', nodes_evaluated: 8, duration_ms: 31400 },
  { id: 'exec-kudig-033', workflow_id: 'wf-kudig-helm', workflow_name: 'Helm Release 异常故障树', status: 'completed', started_at: '2026-08-11T12:00:00Z', completed_at: '2026-08-11T12:00:19Z', trigger: 'alert-helm-release-fail', root_cause: 'Helm Release values 参数类型错误', nodes_evaluated: 7, duration_ms: 19200 },
  { id: 'exec-kudig-034', workflow_id: 'wf-kudig-crd', workflow_name: 'CRD/Operator 异常故障树', status: 'completed', started_at: '2026-08-12T08:00:00Z', completed_at: '2026-08-12T08:00:12Z', trigger: 'alert-crd-conversion-fail', root_cause: 'CRD conversion webhook 配置缺失', nodes_evaluated: 9, duration_ms: 12200 },
  { id: 'exec-kudig-035', workflow_id: 'wf-kudig-networkpolicy', workflow_name: 'NetworkPolicy 异常故障树', status: 'completed', started_at: '2026-08-11T17:30:00Z', completed_at: '2026-08-11T17:30:08Z', trigger: 'alert-networkpolicy-pod-isolation', root_cause: 'NetworkPolicy 默认 deny-all，未配置例外规则', nodes_evaluated: 6, duration_ms: 8100 },
  { id: 'exec-kudig-036', workflow_id: 'wf-kudig-psp', workflow_name: 'PSP/SCC 策略异常故障树', status: 'completed', started_at: '2026-08-10T14:00:00Z', completed_at: '2026-08-10T14:00:05Z', trigger: 'alert-psp-pod-rejected', root_cause: 'PodSecurityPolicy 拒绝了 privileged 容器', nodes_evaluated: 6, duration_ms: 5200 },
  { id: 'exec-kudig-037', workflow_id: 'wf-kudig-resourcequota', workflow_name: 'ResourceQuota 异常故障树', status: 'completed', started_at: '2026-08-11T09:45:00Z', completed_at: '2026-08-11T09:45:16Z', trigger: 'alert-quota-exceeded', root_cause: 'Namespace CPU quota 耗尽，新 Pod 无法调度', nodes_evaluated: 7, duration_ms: 16200 },
  { id: 'exec-kudig-038', workflow_id: 'wf-kudig-webhook', workflow_name: 'Webhook Admission 异常故障树', status: 'completed', started_at: '2026-08-12T12:00:00Z', completed_at: '2026-08-12T12:00:21Z', trigger: 'alert-webhook-cert-expired', root_cause: 'MutatingWebhook 证书过期，请求被拒绝', nodes_evaluated: 7, duration_ms: 21200 },
  { id: 'exec-kudig-039', workflow_id: 'wf-kudig-backup', workflow_name: 'Backup/Restore 异常故障树', status: 'completed', started_at: '2026-08-11T23:00:00Z', completed_at: '2026-08-11T23:00:14Z', trigger: 'alert-velero-backup-failed', root_cause: 'Velero s3 bucket 凭证过期', nodes_evaluated: 8, duration_ms: 14200 },
  { id: 'exec-kudig-040', workflow_id: 'wf-kudig-cloudprovider', workflow_name: 'Cloud Provider 异常故障树', status: 'completed', started_at: '2026-08-12T14:00:00Z', completed_at: '2026-08-12T14:00:09Z', trigger: 'alert-alibaba-cloud-api-throttling', root_cause: '阿里云 API 调用频率超过限额', nodes_evaluated: 10, duration_ms: 9200 },
  { id: 'exec-kudig-041', workflow_id: 'wf-kudig-terway', workflow_name: 'Terway CNI 异常故障树', status: 'completed', started_at: '2026-08-11T19:00:00Z', completed_at: '2026-08-11T19:00:18Z', trigger: 'alert-terway-eni-ip-exhausted', root_cause: 'Terway ENI IP 地址池耗尽', nodes_evaluated: 7, duration_ms: 18200 },
];
...
const mockTickets: OpsTicket[] = [
  { id: 'INC-2026-0891', title: 'ECS 实例 CPU 持续高负载告警', status: 'processing', priority: 'high', created_at: '10 分钟前', assignee: '张明' },
  { id: 'INC-2026-0890', title: 'SLB 后端服务健康检查失败', status: 'pending', priority: 'critical', created_at: '25 分钟前', assignee: '李强' },
  { id: 'INC-2026-0889', title: 'RDS 主从同步延迟超过阈值', status: 'completed', priority: 'medium', created_at: '1 小时前', assignee: '王芳' },
  { id: 'INC-2026-0888', title: 'K8s 节点 NotReady 状态', status: 'approved', priority: 'high', created_at: '2 小时前', assignee: '赵伟' },
  { id: 'INC-2026-0887', title: 'OSS Bucket 跨区域复制失败', status: 'processing', priority: 'medium', created_at: '3 小时前', assignee: '陈静' },
  { id: 'INC-2026-0886', title: 'ACK Ingress 证书即将过期', status: 'pending', priority: 'high', created_at: '4 小时前', assignee: '刘洋' },
  { id: 'INC-2026-0885', title: 'ECS 安全组规则变更审核', status: 'approved', priority: 'low', created_at: '5 小时前', assignee: '周琳' },
  { id: 'INC-2026-0884', title: 'Redis 内存使用率告警', status: 'completed', priority: 'medium', created_at: '6 小时前', assignee: '孙磊' },
];
