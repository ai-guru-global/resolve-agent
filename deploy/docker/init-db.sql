...
-- This file sources the canonical migration scripts from scripts/migration/.
--
-- For development, you may run this file directly. In production, use a
-- migration tool (e.g., golang-migrate, atlas) with scripts/migration/*.
-- =============================================================================

-- NOTE: In Docker, this file is copied into /docker-entrypoint-initdb.d/.
-- The canonical schema lives in scripts/migration/001_init.up.sql.
-- Keep both files in sync, or use a build step to copy from scripts/migration/.
